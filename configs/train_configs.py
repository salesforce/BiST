...
parser.add_argument('--ptr-gen', default=1, type=int, help='using pointer generator instead of normal generator')
parser.add_argument('--ptr-ft', default='query,cap', type=str, help='source text to be pointed by pointer generator')
parser.add_argument('--mask-unk', default=1, type=int, help='mask unknown source tokens when using pointer generator')
