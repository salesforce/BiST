...
parser.add_argument('--cutoff', default=0, type=int, help='') 
...
parser.add_argument('--separate-out-embed', default=1, type=int, help='')
parser.add_argument('--separate-out-linear', default=1, type=int, help='')
...
parser.add_argument('--ptr-gen', default=0, type=int, help='')
parser.add_argument('--ptr-ft', default='query', type=str, help='')
parser.add_argument('--mask-unk', default=0, type=int, help='')
...
parser.add_argument('--enc-vc-combine', default='none', type=str, help='')
parser.add_argument('--vid-enc-mode', default=1, type=int, help='')
