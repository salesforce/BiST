...
class ResNeXt(nn.Module):
    ...
    def __init__(self, block, layers, sample_size, sample_duration, shortcut_type='B', cardinality=32, num_classes=400, last_fc=True, spatio_temporal=False, temporal_only=False):
    ...
    def forward(self, x):
        ...
        if self.spatio_temporal:
            out['spatio-temporal'] = x.squeeze(2)
