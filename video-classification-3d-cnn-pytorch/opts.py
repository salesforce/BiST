...
def parse_opts():
    ...
    parser.add_argument('--tmp', default='tmp', type=str, help='')
    parser.add_argument('--start_idx', default=0, type=int, help='')
    parser.add_argument('--end_idx', default=10000, type=int, help='')
    parser.add_argument('--sample_duration', default=16, type=int, help='')
    parser.add_argument('--spatio_temporal', default=0, type=int, help='')
    parser.add_argument('--temporal_only', default=0, type=int, help='')
    parser.add_argument('--stride', default=-1, type=int, help='')
    parser.set_defaults(verbose=False)
    parser.add_argument('--verbose', action='store_true', help='')
    parser.add_argument('--vidset', default=None, type=str, help='')
    parser.set_defaults(verbose=False)
