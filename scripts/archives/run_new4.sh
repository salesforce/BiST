...
model_prefix=mtn                                                # model name 
    expid=mode${vid_enc_mode}_${fea_names}_cap${include_caption}_cuta${cut_a}_vpos${vpos}_bs${batch_size}_wu${warmup_steps}_eps${num_epochs}_dr${dropout}_d${d_model}_att${att_h}_Nvenc${nb_venc_blocks}_t2s${t2s}_s2t${s2t}_Ncenc${nb_cenc_blocks}_Ndec${nb_blocks}_stenc${enc_st_combine}_vcenc${enc_vc_combine}_stdec${dec_st_combine}_ptr${ptr}_ptrft${ptr_ft}_maskunk${mask_unk}_ae${auto_encoder}
