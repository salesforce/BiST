...
model_prefix=mtn                                                # model name 
    expid=${fea_names}_bs${batch_size}_wu${warmup_steps}_eps${num_epochs}_dr${dropout}_d${d_model}_att${att_h}_N${nb_blocks}_cap${include_caption}_ptr${ptr}_ptrft${ptr_ft}_maskunk${mask_unk}_vpos${vpos}_stdec${dec_st_combine}__stenc${enc_st_combine}_mode${vid_enc_mode}_ae${auto_encoder}_df${dynamic_fusion}_qmm${query_mm}
